...
- [Importare l'inventario da un foglio di calcolo](#importare-linventario-da-un-foglio-di-calcolo)
- [Sicurezza in breve](#sicurezza-in-breve)
- [Come sono divisi gli accessi](#come-sono-divisi-gli-accessi)
- [Come funziona il giro del materiale](#come-funziona-il-giro-del-materiale)
- [Le foto del materiale](#le-foto-del-materiale)
- [I file dei dati](#i-file-dei-dati)
- [Protezione delle cartelle](#protezione-delle-cartelle)
- [Esportazioni](#esportazioni)
- [Se vuoi cambiare qualcosa](#se-vuoi-cambiare-qualcosa)
- [Aggiornare l'applicativo](#aggiornare-lapplicativo)
...
Il progetto non richiede build: si modifica il PHP direttamente.
